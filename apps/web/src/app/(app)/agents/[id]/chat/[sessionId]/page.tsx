...
export default function ChatPage() {
  ...
  const [activeSessionId, setActiveSessionId] = useState<string | null>(params.sessionId);
  ...
  function switchToSession(sessionId: string) {
    ...
    router.replace(`/agents/${agentId}/chat/${sessionId}`, { scroll: false });
  }
  ...
  const handleDeleteSession = useCallback(async () => {
    ...
    try {
      ...
      setSessions((prev) => {
        ...
        if (activeSessionId === deleteSessionId && next.length > 0) {
